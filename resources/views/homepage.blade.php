...
<body class="mx-0 px-0">
    ...
    <div class="row ">
      <div class="col-12 col-lg-6 ">
        <div class="row vh-100">
          <div class="col-12 d-flex flex-column justify-content-center animate__animated animate__fadeInDown ps-5">
            <h2 class="h2_header ">Find Your</h2>
            <h1 class="cust_h1 ">Unique Style</h1>
            <button class="cust_buttun px-5 py-3 mt-4 ">SHOP NOW<img src="https://img.icons8.com/ios/25/020774/long-arrow-right--v1.png" class="ps-2"/></button>
          </div>
          <div class="col-12 mx-0 px-0 justify-content-end d-flex flex-column ">
            <img src="media/HomePage-hero-pic.jpg" class="img-fluid animate__animated animate__slideInUp" alt="">
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-6 cust_bg_head d-flex flex-column justify-content-center align-items-center animate__animated animate__fadeInRight">
        <button class="cust_but_aces ">
          <img src="media/Accessories.jpg" class="img-fluid pb-3" alt="">
          <p  class="text-white">Rhinoboards Wooden 8.0″ Complete Skateboard</p>
  ...
  {{-- sezione paragrafo --}}
  <div class="container-fluid ">
    <div class="row cust_section mb-5">
      <div class="col-12 text-center  mt-5 justify-content-center align-items-center d-flex flex-column">
        <h2 class="h2_cust_paragrafo">Welcome To Street Smart Shop</h2>
        <p class="cut_p_Paragrafo">Lorem ipsum dolor sit amet, consectet adipiscing elit,sed do eiusm por incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrudexercitation ullamco laboris nisi ut aliquip ex ea sint occaecat cupidatat non proident, sunt in culpa qui officia</p>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row ">
      <div class="col-12 col-lg-6  d-flex flex-column justify-center align-items-center">
        <div class="d-flex">
          <span class="tit_1">Style</span><span class="tit_2">Accessories</span>
        </div>
        <button class="cust_but_aces">
          <a class="nav-link mx-2" href="{{route('accessories')}}">
            <img src="media/Accessories.jpg" class="img-fluid" alt="">
          </a>
        </button>
      </div>
      <div class="col-12 col-lg-6  d-flex flex-column justify-center align-items-center">
        <div class="d-flex">
          <span class="tit_1">Style</span><span class="tit_2">Clothing</span>
        </div>
        <button class="cust_but_aces">
          <a class="nav-link mx-2" href="{{route('clothing')}}">
            <img src="media/Accessories.jpg" class="img-fluid" alt="">
          </a>
        </button>
      </div>
