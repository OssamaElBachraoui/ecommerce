    ...
    <div class="container">
        <div class="row ">
            <div class="col-12 text-center">
                <span class="tit_1">Customer</span><span class="tit_2">Support</span>
            </div>
            ...
            <div class="col-12 justify-content-center d-flex flex-column align-items-center ">
                <p class="cust_width">Lorem ipsum dolor sit amet, consectet adipiscing elit,sed do eiusm por incididunt ut labore et dolore magna aliqua. Ut enim ad minim</p>
            </div>
