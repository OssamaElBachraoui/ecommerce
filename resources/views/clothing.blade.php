...
<body class="mx-0 px-0">
      ...
      <div class="col-12 col-lg-6 ">
        <div class="row vh-100">
          <div class="col-12 d-flex flex-column justify-content-center animate__animated animate__fadeInDown ps-5">
            <h2 class="h2_header ">Shop</h2>
            <h1 class="cust_h1_cloa ">Cloathing</h1>
          </div>
          <div class="col-12 mx-0 px-0 justify-content-end d-flex flex-column ">
            <img src="https://library.elementor.com/urban-shop/wp-content/uploads/sites/112/2020/10/clothing-features-image.jpg" class="img-fluid animate__animated animate__slideInUp" alt="">
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-6 cust_bg_head_clothing d-flex flex-column justify-content-center align-items-center animate__animated animate__fadeInRight">
        <button class="cust_but_aces ">
          <img src="https://library.elementor.com/urban-shop/wp-content/uploads/sites/112/2020/10/skateboard2.jpg" class="img-fluid pb-3" alt="">
          <p  class="p_blu">RhinoBoards 7.4” Complete Skateboard</p>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-12  col-lg-4 div_cloat d-flex flex-column align-items-center justify-content-center">
        <a href="{{route('dettaglio' , ['name' => $clothing['name']])}}" class="">
          <button class="clo_but mt-5">
            <img src="{{$clothing['img']}}" class="img-fluid" alt="">
            <p class="text-white pt-3 ">{{$clothing['name']}}</p>
            <span class=" pe-2 cust_line_T">{{$clothing['fullPrice']}}</span><span class="text-white text-decoration-underline">{{$clothing['price']}}</span>
            <br>
            <p class="cust_add_card pt-3">ADD TO CART</p>
          </button>
        </a>
      </div>
      @endforeach
