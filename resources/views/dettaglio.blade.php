  ...
  <div class="container-fluid">
    <div class="row ">
      <div class="col-12 col-lg-6 cust_bg_head d-flex flex-column justify-content-center align-items-center animate__animated animate__fadeInRight">
        <img src="{{$clothing['img']}}" class="img-fluid pb-3" alt="">
      </div>
        <div class="col-12 col-md-6 d-flex flex-column  mt-5 mx-auto ps-5">
            <div class="d-flex py-5">
                <a class="text-decoration-none" href="{{route('homepage')}}">Home/</a><a class="text-decoration-none" href="{{route('clothing')}}"> Cloathing/</a><p>{{$clothing['name']}}</p>
            </div>
            <div class="py-5">
                <h3>Get Your</h3>
                <h2>{{$clothing['name']}}</h2>
            ...
            <div class="py-3">
                <span class=" pe-2 cust_line_T ">{{$clothing['fullPrice']}}</span><span>{{$clothing['price']}}</span>
                <br>
                <span>{{$clothing['description']}}</span>
            </div>
            <div class="py-5">
              <button class="cust_buttun px-5 py-3 mt-4 ">BUY NOW</button>
          </div>
        </div>
    </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row div_email mt-5 d-flex align-items-center justify-content-center">
      ...
      <div class="col-12 col-md-3 my-3 text-center">
        <button class="cust_buttun_email mx-4 px-5 ">EMAIL<img src="https://img.icons8.com/ios/25/020774/long-arrow-right--v1.png" class="ps-2"/></button>
      </div>
